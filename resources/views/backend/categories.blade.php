   ...
   <div class="content-body">
      ...
      <section id="basic-form-layouts">
            ...
            <div class="col-md-12">
               <div class="card">
                  <div class="card-header">
                     <h4 class="card-title" id="basic-layout-round-controls">Add Categories</h4>
        ...
        <?php endif ?>
                        ...
                        <form class="form" action="{{route('Admin.Store_categories')}}" method="post">
                          {{ csrf_field()}}
                           <div class="form-body">
                              <div class="form-group">
                                 <label for="complaintinput1">Categories Name</label>
                                 <input type="text" class="form-control round" placeholder="Enter Category Name" name="name">
                              </div>
