...
@section('pageContent')
 <section class="hero-section" data-scrollax-parent="true" id="sec1">
                        <div class="hero-parallax">
                            <div class="bg"  data-bg="{{URL::asset('resources/images/bg/22.jpg')}}" data-scrollax="properties: { translateY: '200px' }"></div>
                        ...
                        <div class="container">
                            ...
                            <div class="gallery-items fl-wrap mr-bot spad home-grid">
                                ...
                                <div class="gallery-item">
                                    <div class="grid-item-holder">
                                        <div class="listing-item-grid">
                                            ...
                                            <img  src="{{URL::asset('resources/images/city/7.jpg')}}"   alt="">
                                ...
                                <div class="gallery-item gallery-item-second">
                                    <div class="grid-item-holder">
                                        <div class="listing-item-grid">
                                            <img  src="{{URL::asset('resources/images/city/3.jpg')}}"   alt="">
                                ...
                                <div class="gallery-item">
                                    <div class="grid-item-holder">
                                        <div class="listing-item-grid">
                                            ...
                                            <img  src="{{URL::asset('resources/images/city/2.jpg')}}"   alt="">
                                            <div class="listing-item-cat">
                                ...
                                <div class="gallery-item">
                                    <div class="grid-item-holder">
                                        <div class="listing-item-grid">
                                            ...
                                            <img  src="{{URL::asset('resources/images/city/5.jpg')}}"   alt="">
                                            <div class="listing-item-cat">
                                ...
                                <div class="gallery-item">
                                    <div class="grid-item-holder">
                                        <div class="listing-item-grid">
                                            ...
                                            <img  src="{{URL::asset('resources/images/city/6.jpg')}}"   alt="">
                                            <div class="listing-item-cat">
                            ...
                            <div class="listing-carousel  fl-wrap ">
                                    ...
                                    <div class="listing-item">
                                        <article class="geodir-category-listing fl-wrap">
                                            <div class="geodir-category-img">
                                                <a href="listing-single.html"><img src="{{URL::asset('resources/images/gal/8.jpg')}}" alt=""></a>
                                                <div class="listing-avatar"><a href="author-single.html"><img src="{{URL::asset('resources/images/avatar/1.jpg')}}" alt=""></a>
                                ...
                                <div class="slick-slide-item">
                                    ...
                                    <div class="listing-item">
                                        <article class="geodir-category-listing fl-wrap">
                                            <div class="geodir-category-img">
                                                <a href="listing-single.html"><img src="{{URL::asset('resources/images/gal/4.jpg')}}" alt=""></a>
                                                <div class="listing-avatar"><a href="author-single.html"><img src="{{URL::asset('resources/images/avatar/2.jpg')}}" alt=""></a>
                                ...
                                <div class="slick-slide-item">
                                    ...
                                    <div class="listing-item">
                                        <article class="geodir-category-listing fl-wrap">
                                            <div class="geodir-category-img">
                                                <a href="listing-single.html"><img src="{{URL::asset('resources/images/gal/6.jpg')}}" alt=""></a>
                                                <div class="listing-avatar"><a href="author-single.html"><img src="{{URL::asset('resources/images/avatar/3.jpg')}}" alt=""></a>
                                ...
                                <div class="slick-slide-item">
                                    ...
                                    <div class="listing-item">
                                        <article class="geodir-category-listing fl-wrap">
                                            <div class="geodir-category-img">
                                                <a href="listing-single.html"><img src="{{URL::asset('resources/images/gal/2.jpg')}}" alt=""></a>
                                                <div class="listing-avatar"><a href="author-single.html"><img src="{{URL::asset('resources/images/avatar/4.jpg')}}" alt=""></a>
                                ...
                                <div class="slick-slide-item">
                                    ...
                                    <div class="listing-item">
                                        <article class="geodir-category-listing fl-wrap">
                                            <div class="geodir-category-img">
                                                <a href="listing-single.html"><img src="{{URL::asset('resources/images/gal/3.jpg')}}" alt=""></a>
                                                <div class="listing-avatar"><a href="author-single.html"><img src="{{URL::asset('resources/images/avatar/5.jpg')}}" alt=""></a>
                                ...
                                <div class="slick-slide-item">
                                    ...
                                    <div class="listing-item">
                                        <article class="geodir-category-listing fl-wrap">
                                            <div class="geodir-category-img">
                                                <a href="listing-single.html"><img src="{{URL::asset('resources/images/gal/5.jpg')}}" alt=""></a>
                                                <div class="listing-avatar"><a href="author-single.html"><img src="{{URL::asset('resources/images/avatar/1.jpg')}}" alt=""></a>
                                                    <span class="avatar-tooltip">Added By  <strong>Alisa Noory</strong></span>
                                                </div>
                            ...
                            <div class="text-carousel single-carousel fl-wrap">
                                ...
                                <div class="slick-item">
                                    <div class="text-carousel-item">
                                        <div class="popup-avatar"><img src="{{$value->featured}}" alt="{{$value->featured}}"></div>
                                        <div class="listing-rating card-popup-rainingvis" data-starrating2="5"> </div>
                                        <div class="review-owner fl-wrap">{{$value->name}} - <span>{{$value->cat_name}}</span></div>
                                        <p>{{$value->content}}</p>
